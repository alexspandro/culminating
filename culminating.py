...
oneW = int("What is your weight on the 1st day?"))
twoW = int("What is your weight on the 2nd day?"))
threeW = int("What is your weight on the 3rd day?"))
fourW = int("What is your weight on the 4th day?"))
fiveW = int("What is your weight on the 5th day?"))
sixW = int("What is your weight on the 6th day?"))
sevenW = int("What is your weight on the 7th day?"))
...
with open ("userWeightinfo.csv", "w") as file:
  ...
  file.writelines("Day 1: " + oneW + "\n")
  file.writelines("Day 2: " + twoW + "\n")
  file.writelines("Day 3: " + threeW + "\n")
  file.writelines("Day 4: " + fourW + "\n")
  file.writelines("Day 5: " + fiveW + "\n")
  file.writelines("Day 6: " + sixW + "\n")
  file.writelines("Day 7: " + sevenW + "\n")
